...
$getAllPosts = CMS->DataBase->execute('SELECT * FROM blog_single ORDER BY ID DESC')->fetchAll();
...
$getAllPosts = CMS->DataBase->execute('SELECT * FROM blog_single ORDER BY ID DESC LIMIT '.$depart.','.$itemPage)->fetchAll();

include "interface/posts.php";
?>