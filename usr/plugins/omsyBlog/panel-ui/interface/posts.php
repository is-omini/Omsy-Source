<section class="appUiKit-user-top-menu">
    ...
    <div class="content">
        <ul>
            <li><a class="active" href="/panel/getter?plugin=MinBlog&page=posts" data-update="embed">Liste des chaine</a></li>
            <li><a href="/panel/getter?plugin=MinBlog&page=post" data-update="embed">Ajouter une chaine</a></li>
        </ul>
    </div>
</section>
<section class="appUiKit-table">
    <table>
        ...
        <tr>
            <td><b><a data-update="embed" href="/panel/getter?plugin=MinBlog&page=post&ID=<?= $value['ID'] ?>"><?= CMS->GFunction->htmlDecode($value['blog_title']) ?></a></b></td>
            <td><?= CMS->GFunction->web_substr($value['blog_content'], 55) ?></td>
            ...
            <td>
                <ul>
					...
					<li>
						<a class="button-ui-svg" target="_blank" href="/panel/getter?plugin=MinBlog&page=rm" class="title-stream">
